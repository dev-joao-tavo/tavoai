...
import time
from configs import login, initialize_driver, set_switcher, get_ids_from_stage
...
def main():
    ...
    for stage_id in PIPELINE_STAGES.values():
        ...
        if stage_id == PIPELINE_STAGES[f"{pipelineStage}"]:
            message = messages.pipelineStageMessage
